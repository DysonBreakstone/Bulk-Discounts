...
RSpec.describe 'invoices show' do
  describe "existing project" do
    ...
    it "shows the item information" do
      ...
      expect(page).to have_content("$#{(@ii_1.unit_price / 100).round(2)}")
      expect(page).to_not have_content("$#{(@ii_4.unit_price / 100).round(2)}")
    ...
    it "shows the total revenue for this invoice" do
      ...
      expect(page).to have_content(@invoice_1.total_merchant_revenue(@merchant1) / 100)
    end
  ...
  describe "Bulk discounts" do
    ...
    it "shows full price and discounted price" do
      visit merchant_invoice_path(@merchant_1, @invoice_1)
      
      expect(page).to have_content("Total Revenue: 55.0")
      expect(page).to have_content("Total Discounts: 2.5")
      expect(page).to have_content("Total Sum: 52.5")
      ...
      expect(page).to have_content("Total Revenue: 1630.0")
