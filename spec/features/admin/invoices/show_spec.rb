...
describe 'Admin Invoices Index Page' do
  describe "existing repository" do
    ...
    it 'should display the total revenue the invoice will generate' do
      expect(page).to have_content("Total Revenue: $#{@i1.total_revenue / 100}")
  ...
  describe "Bulk Discounts" do
    ...
    it "shows total revenue, discount, and total sum" do
      visit admin_invoice_path(@invoice_1)
    
      expect(page).to have_content("Total Revenue: $1140.0")
      expect(page).to have_content("Total Discounts: $368.0")
      expect(page).to have_content("Total Sum: $772.0")
    end
